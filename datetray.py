...
class Datetray(QApplication):
    def __init__(self, *args, **kwargs):
        ...
        notify.send("DateTray", "start", "DateTray", msg, ['start', 'update'], icon = self.name)
    ...
    def updateIcon(self):
        ...
        notify.send("DateTray", "update", "DateTray", msg, ['start', 'update'], icon = self.name)
        ...
        print(msg1)
        notify.send("DateTray", "update", "DateTray", msg1, ['start', 'update'], icon = self.name)
        self.draw_date()
